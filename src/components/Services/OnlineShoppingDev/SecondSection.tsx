      ...
      >
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light leading-tight tracking-tight">
            ...
            <motion.span
              ...
              className="bg-gradient-to-r from-red-600 via-red-500 to-red-600 bg-clip-text text-transparent font-extralight ml-4"
            >
              App Development
            </motion.span>
          </h2>
        ...
        <div className="space-y-8">
          ...
          <motion.div
            ...
            className="relative"
          >
            <p className="text-base md:text-lg leading-relaxed font-light text-slate-400 tracking-wide">
              At Lazy Do, we have expertise in designing smart
              and scalable platforms to take your online business to the next
              level. Our end-to-end eCommerce solutions enable entrepreneurs and
              businesses to seamlessly build, run, and scale their digital
              storehouses with simplicity and effectiveness. We develop a variety of eCommerce mobile apps and websites for clients
              worldwide, providing flexible, secure mobile commerce applications for
              Business-to-Business (B2B) and Business-to-Consumer (B2C)
              applications. Whether it's a single brand store or a
              multi-brand business, we provide solutions that fit your
