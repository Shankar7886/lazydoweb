...
export default function FirstSection() {
  ...
  return (
    <>
      <ParallaxText text="E-COMMERCE · ONLINE SHOPPING ·" direction="right" speed={140} opacity={0.04} />

      <section ref={sectionRef} style={{ position: "relative", overflow: "hidden" }} className="pt-16 sm:pt-20 md:pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <GradientMesh
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16">
          {/* Left Content — layer 2 heading parallax */}
          <div style={{ overflow: "hidden" }} className="w-full lg:w-1/2">
            <motion.div
              style={{ y: headY }}
      ...
      <ParallaxText text="CONVERT · SELL · SCALE ·" direction="left" speed={120} opacity={0.04} />
    </>
  );
}
