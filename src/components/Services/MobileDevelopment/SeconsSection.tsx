...
export default function WebDevelopmentServicesSection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 px-6 text-center relative overflow-hidden">
      <motion.div style={{ y }} className="absolute top-20 right-20 w-32 h-32 opacity-10">
        <div className="w-full h-full border border-slate-300/30 rounded-3xl rotate-12" />
      </motion.div>

      <motion.div style={{ y: yAlt }} className="absolute bottom-32 left-16 w-20 h-20 opacity-20">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light leading-tight tracking-tight">
            ...
            <motion.span
              ...
              className="bg-gradient-to-r from-red-600 via-darkred-600 to-red-600 bg-clip-text text-transparent font-extralight ml-10"
            >
              Development
            </motion.span>
          </h2>
  ...
  >
    <p className="text-xl md:text-2xl leading-relaxed font-light text-slate-600 tracking-wide">
      <WordHighlight index="mayank">Lazy Do</WordHighlight> is committed to keeping pace with changing industry standards,
      providing <WordHighlight index="end-to-end">end-to-end web development services</WordHighlight> through <WordHighlight index="user-centric">user-centric approaches</WordHighlight>. Our solutions
      are specifically designed to suit the specific needs of each client and maximize their <WordHighlight index="digital-impact">digital impact</WordHighlight>.
    </p>
  </motion.div>
  ...
  >
    <p className="text-xl md:text-2xl leading-relaxed font-light text-slate-600 tracking-wide">
      No matter what type of business you’re running, having a <WordHighlight index="mobile-app">mobile application</WordHighlight> can make your business 5+ times faster. 
      <WordHighlight index="mayank">Lazy Do</WordHighlight> is a leading <WordHighlight index="mobile-app-company">Mobile Application Development Company</WordHighlight> serving international clients with result-oriented solutions. 
      We offer a wide range of mobile app solutions for all major platforms—<WordHighlight index="ios">iOS</WordHighlight>, <WordHighlight index="android">Android</WordHighlight>, <WordHighlight index="windows">Windows</WordHighlight>, etc.
      Our in-house team of experienced mobile app programmers has excellent knowledge of cutting-edge technologies and development tools.
      They’ve created <WordHighlight index="innovative">innovative</WordHighlight> and <WordHighlight index="future-ready">future-ready</WordHighlight> apps for a variety of brands, startups, and enterprises.
      As the best <WordHighlight index="mobile-india">Mobile App Development Company in India</WordHighlight>, our goal is to build industry-specific digital ecosystems that grow your customer base by millions.
      We specialize in high-quality, platform-specific solutions for <WordHighlight index="b2b">B2B</WordHighlight>, <WordHighlight index="b2c">B2C</WordHighlight>, and <WordHighlight index="c2b">C2B</WordHighlight> businesses.
    </p>
  </motion.div>
</div>
