    ...
    <section ref={sectionRef} className="py-24 px-6 text-center relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-10">
          ...
          >
            <p className="text-xl md:text-2xl leading-relaxed font-light text-slate-600 tracking-wide">
              A <WordHighlight index="beautiful">beautiful-looking</WordHighlight> and <WordHighlight index="interactive">interactive website</WordHighlight> is necessary for creating a <WordHighlight index="impression">long-lasting impression</WordHighlight>
              on your visitors—and we assist you in doing just that. Our team of <WordHighlight index="experienced">experienced web designers</WordHighlight>
              and developers, with a profound understanding of <WordHighlight index="modern">modern web technologies</WordHighlight>, builds <WordHighlight index="world-class">world-class</WordHighlight>,
              <WordHighlight index="personalized">personalized websites</WordHighlight> tailored for startups to large enterprises.
            </p>
          </motion.div>
        </div>
      </motion.div>
