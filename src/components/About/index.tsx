...
/* ── Three.js background scene (lifted from FirstSection) ── */
...
function AdvancedTechScene() {
  ...
  return (
    <>
      ...
      <directionalLight position={[15, 15, 10]} intensity={0.8} color="#fff8dc" />
...
const AboutUs: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-white text-gray-900 min-h-screen">
      {/* Global full-page Three.js canvas background */}
