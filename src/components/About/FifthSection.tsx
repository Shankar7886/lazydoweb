...
const industryContent = [
  {
    ...
    expertise:
      "Our expertise spans MVP development, scalable architecture design, growth analytics implementation, and market validation strategies. We work closely with founders to transform visionary ideas into investor-ready platforms that speak the language of both users and stakeholders.",
  },
  {
    ...
    continuation:
      "Understanding that resources are precious and every investment must yield measurable returns, we've developed a methodology that maximizes impact through strategic technology choices. Our portfolio includes over 500 small business transformations, each one a testament to the power of thoughtful digital strategy combined with intimate understanding of local market dynamics.",
    expertise:
      "We specialize in custom solution development, e-commerce platform creation, digital marketing integration, local SEO optimization, and customer engagement tools that turn one-time buyers into lifelong advocates.",
  },
  {
    title: "Enterprise",
    description:
    ...
    continuation:
      "The enterprise landscape demands more than technical expertise; it requires strategic vision, unwavering precision, and the ability to orchestrate seamless integration across multiple departments, systems, and stakeholders. Our team has successfully delivered 50+ enterprise-level transformations, each one executed with zero downtime and maximum impact.",
    expertise:
      "Our enterprise capabilities encompass sophisticated architecture design, legacy system modernization, cloud migration strategies, comprehensive digital transformation, and enterprise-grade security implementations that protect while they enable.",
  },
];
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-thin text-slate-900 leading-none mb-6"
          >
            We{" "}
            <span
              style={{
          ...
          >
            We are a collective of creative developers and strategic professionals
            who believe in building inclusive, client-centric, and infinitely
            scalable solutions using the most sophisticated technologies and
                ...
                >
                  ...
                  >
                    ...
                    <motion.p
                      ...
                      animate={
                        activeSection === index
                          ? { opacity: 1, color: "#64748b", fontStyle: "normal" }
                          : { opacity: 0.7, color: "#94a3b8", fontStyle: "italic" }
                      }
        ...
        >
          ...
          >
            ...
            Our role is to listen, understand, and craft solutions that don't
