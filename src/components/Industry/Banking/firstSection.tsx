...
export default function FintechLanding() {
  ...
  return (
    <>
      <ParallaxText text="BANKING & FINTECH · DIGITAL FINANCE ·" direction="right" />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div style={{ y: blobY }} className="w-full h-full">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-3xl"
              style={{ background: `rgba(30,64,175,0.07)` }} />
          </motion.div>
        </div>

        <div className="relative z-10 flex flex-col lg:flex-row min-h-screen">
          {/* Left Content with heading parallax */}
          <div className="flex-1 px-4 sm:px-6 lg:px-12 py-8 sm:py-12 lg:py-20 flex flex-col justify-center order-2 lg:order-1 overflow-hidden">
            <motion.div
              style={{ y: headY }}
          ...
          {/* Right: Lottie + Dashboard Mockup with image parallax */}
          <div className="flex-1 p-4 sm:p-6 lg:p-12 flex items-center justify-center relative order-1 lg:order-2 min-h-[50vh] lg:min-h-screen overflow-hidden">
            <motion.div style={{ y: imageY }} className="relative z-10 w-full max-w-xs sm:max-w-sm md:max-w-md space-y-3 sm:space-y-4">
      ...
      <ParallaxText text="SECURE · COMPLIANT · MODERN ·" direction="left" />
    </>
  );
}
