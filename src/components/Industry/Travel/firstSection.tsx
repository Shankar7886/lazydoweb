...
export default function CustomWebDevPage() {
  ...
  return (
    <>
      <ParallaxText text="TRAVEL & TOURISM · EXPERIENCES ·" direction="right" />
              ...
              >
                <div className="grid lg:grid-cols-2 min-h-[500px]">
                  ...
                  <div className="overflow-hidden">
                    <motion.div style={{ y: headY }} className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <div className="overflow-hidden relative min-h-[400px] lg:min-h-full">
                    <motion.div
                      style={{ y: imageY }}
      ...
      <ParallaxText text="EXPLORE · DISCOVER · JOURNEY ·" direction="left" />
    </>
  );
}
