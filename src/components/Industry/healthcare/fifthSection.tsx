        ...
        <div className="relative h-[600px] md:h-[700px] flex items-center justify-center">
          ...
          >
            <div className="w-52 md:w-60 h-80 md:h-96 bg-gradient-to-b from-gray-900 to-gray-800 rounded-[2.5rem] p-2.5 shadow-2xl">
              <div className="w-full h-full bg-gradient-to-b from-blue-50 to-green-100 rounded-[2rem] flex items-center justify-center relative overflow-hidden">
          ...
          {features.map((feature, index) => {
            ...
            const isTop = feature.position.top
              ? parseFloat(feature.position.top) < 50
              : false;
              ...
              >
                <div className="relative z-10 w-60 h-24 backdrop-blur-md bg-white/20 border border-white/30 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-white/30 p-4 flex flex-col justify-center">
                  <div className="flex items-center gap-2 mb-1.5">
                    <div
                      className="w-7 h-7 rounded-lg flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform duration-300"
                      style={{ background: "var(--color-accent-primary)" }}
                    >
                      {feature.icon}
                    </div>
                  ...
                  <div
                    className="absolute w-0.5 h-8 opacity-30 group-hover:opacity-60 transition-opacity duration-300"
                    style={{
                  ...
                  />
                  <div
                    className="absolute w-2 h-2 rounded-full shadow-lg group-hover:scale-125 transition-all duration-300"
                    style={{
                      background: "var(--color-accent-primary)",
                      left: "50%",
                      transform: "translateX(-50%)",
