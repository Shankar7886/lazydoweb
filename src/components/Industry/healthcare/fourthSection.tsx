...
const TechStackOverview: React.FC = () => {
  ...
  return (
    <section className="relative py-24 px-4 overflow-hidden">
      <GradientMesh colors={["#d4f0e8", "#e8f4fd", "#f0ffe8"]} intensity={0.6} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-thin text-slate-800 mb-6 leading-tight">
            Tech That Powers Our
            <br />
            <span
              style={{
                background:
                  "linear-gradient(90deg, var(--color-accent-primary), #3b82f6)",
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
            Innovation is in our DNA at Lazy Do. We harness cutting-edge
            technologies to create healthcare experiences that are smarter,
              ...
              <ScrollReveal key={item.id} direction="up" delay={i * 0.1}>
                <TiltCard>
                  <div
                    ...
                    className={`glass-card rounded-2xl p-6 cursor-pointer transition-all duration-500 transform ${
                      isActive ? "scale-105 z-20" : isHovered ? "scale-[1.02]" : "scale-100"
                    }`}
                  >
                  ...
                  {isActive && (
                    <>
                      <div className="flex items-center gap-4 mb-8">
                        <div
                          className={`p-3 rounded-xl bg-gradient-to-br ${item.bgGradient} text-white shadow-lg`}
                        >
