        ...
        <div className="relative px-6 md:px-20 pt-12 pb-6">
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium uppercase tracking-wider" style={{ color: "var(--color-accent-primary)" }}>
                        Digital Excellence
                      </p>
                    </div>
                  </div>
            ...
            <div className="space-y-5">
              <h3 className="text-gray-900 font-light text-lg relative">
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(to right, var(--color-accent-primary), #ef4444)" }}
                />
              </h3>

              <ul className="space-y-3">
                {serviceLinks.map((link, index) => (
                  <ScrollReveal key={index} direction="left" delay={index * 0.05}>
                    <li className="group cursor-pointer">
                      <a
                        href={link.path}
                        className="flex items-center space-x-3 text-gray-500 hover:text-red-600 transition-all duration-300"
                      >
                        <ArrowRight
                          size={14}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 pt-4">
            <div className="text-gray-400 font-light text-sm">
              &copy; {new Date().getFullYear()} Lazy Do. All rights reserved.
            </div>
